        ...
        <section class="footer_menu main_container">
            <div class="row">
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 footer_newsletter">
                    ...
                    <form id="subForm" class="js-cm-form" action="https://www.createsend.com/t/subscribeerror?description=" method="post" data-id="92D4C54F0FEC16E5ADC2B1904DE9ED1AA0DD7DB141E3D88EFBCC66B0A005FAE472CB246984226443F57628F6D12F6E9372778D540690651D1BBF3E28293C4F5B">	
            ...
            <div class="main_container row">
                <div>
                    <p class="footer_text">
                        ...
                        <router-link to="/pages/centralparkplaza-retailer-hub" exact>Retailer Hub</router-link> |
...
<script>
    define(["Vue", "vuex", "moment", "moment-timezone", "vue-moment", "json!site.json", "vue!vue_facebook", "campaignMonitor"], function (Vue, Vuex, moment, tz, VueMoment, site, vueFacebookPage, campaignMonitor) {
        return Vue.component("footer-component", {
            ...
            mounted () {
                window.MktoForms2.loadForm("//app-sj03.marketo.com", "561-LJY-710", 3300);
            },
            created () {
